...
export const normalizePickerAsset = (asset: PickerAssetLike, blob?: Blob): UploadSource => {
...
export const createUploadSourceFromPickerAsset = async (asset: PickerAssetLike): Promise<UploadSource> => {
